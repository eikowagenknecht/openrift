...
- **[ADR-019](019-trade-execution.md)**: In-App Trade Execution for Friend Groups — proposed (supersedes ADR-013's "no trade execution" and "notifications deferred" stances)
