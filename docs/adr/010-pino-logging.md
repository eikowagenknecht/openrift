...
# ADR-010: Use pino for structured logging
...
We use pino. It fits the existing stack (Bun, Hono, Docker), and its JSON-to-stdout model matches Docker's log capture. Winston would also work but is heavier and less natural in this ecosystem.
