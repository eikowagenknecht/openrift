 ...
 * super-types, art-variants): lowercase, starts with a letter, single dashes
 * between alphanumeric runs. Feature-flag and site-setting *keys* use a stricter
 * 2+-character variant and deliberately keep their own regex.
 */
