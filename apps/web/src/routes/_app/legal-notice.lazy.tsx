  ...
  return (
    <>
      <article className="prose dark:prose-invert mx-auto max-w-2xl px-3 py-3">
        ...
        <p>
          The author assumes no warranty for the currentness, correctness, completeness, or quality
          of the provided information. Liability claims against the author relating to material or
          non-material damage caused by the use or non-use of the provided information, or by the
          use of incorrect or incomplete information, are generally excluded, unless the author is
          proven to have acted with willful intent or gross negligence.
        </p>
        <p>
          All offerings are non-binding. The author expressly reserves the right to change,
          supplement, or delete parts of the pages or the entire offering without prior notice, or
          to cease publication temporarily or permanently.
        </p>
        ...
        <p>
          The copyright for published objects created by the author remains solely with the author
          of the pages. Any reproduction or use of such graphics, sound documents, video sequences,
          and texts in other electronic or printed publications is not permitted without the express
        ...
        <p>
          This disclaimer is to be regarded as part of the internet offer from which you were
          referred to this page. If sections or individual terms of this statement are not legal or
          correct, the content or validity of the other parts remain uninfluenced by this fact.
        </p>
