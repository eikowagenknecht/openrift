...
import type { AimStreaks } from "@/lib/scan-aim-streak";
import type { LoadedScanBank } from "@/lib/scan-bank";
import { frameLogLine, printingLogLine } from "@/lib/scan-frame-log";
import type { LockedCard, ScannerEvents } from "@/lib/scan-locks";
import { appendLock, lockFromTrack, resolvePrintingIn } from "@/lib/scan-locks";
import {
  IDLE_PACE_DELAY_MS,
  PAUSED_POLL_MS,
  createFpsWindow,
