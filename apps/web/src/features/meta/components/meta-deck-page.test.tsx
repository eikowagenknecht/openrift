...
vi.mock("@/features/decks/components/public-deck-surface", () => ({
  PublicDeckSurface: ({
    topBar,
    notice,
    footer,
...
vi.mock("@/features/decks/components/public-deck-actions-menu", () => ({
  PublicDeckActionsMenu: () => <div>Deck actions</div>,
}));

vi.mock("@/features/meta/components/meta-deck-archive-bar", () => ({
