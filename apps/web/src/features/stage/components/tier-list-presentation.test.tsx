...
vi.mock("@/features/stage/hooks/use-tier-lists", () => ({
...
vi.mock("@/features/stage/hooks/use-tier-list-autosave", () => ({
  useTierListAutosave: () => autosave,
}));

vi.mock("@/features/stage/components/tier-list-dnd-context", () => ({
  TierListDndContext: ({ children }: { children: ReactNode }) => <div>{children}</div>,
}));
vi.mock("@/features/stage/components/tier-board-editor", () => ({
  TierBoardEditor: () => <div data-testid="editor" />,
}));
vi.mock("@/features/stage/components/tier-stage-main", () => ({
  TierStageMain: () => <div data-testid="board-show" />,
}));
vi.mock("@/features/stage/components/card-stage-main", () => ({
...
vi.mock("@/features/stage/components/presentation-stage", () => ({
