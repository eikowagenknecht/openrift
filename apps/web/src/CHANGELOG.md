...
- feat(Decks): **Tell a deck which box it lives in** — pick or create the box a deck is stored in, and a new Box tab shows what is already in it, which collection to pull each remaining card from, and moves them there in one press.
