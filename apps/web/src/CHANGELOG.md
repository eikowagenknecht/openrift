...
- feat(Trades): **Wishlist hearts on tradelists** — a member's tradelist now flags cards already on your wishlist with a red heart (with how many you want), and clicking it opens that wishlist.
