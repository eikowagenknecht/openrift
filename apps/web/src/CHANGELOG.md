...
- fix: When you group cards by rarity, type, domain, or super type, the section headers now show the proper name (like "Rare" or "Unit") instead of the internal code
