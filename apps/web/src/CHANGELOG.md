...
- feat: Promos can now be grouped by card or by year through the same dropdown that picks the sort, alongside the existing channel grouping; year defaults to newest-first
