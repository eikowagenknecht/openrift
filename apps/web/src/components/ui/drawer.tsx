...
function DrawerContent({
  className,
  children,
  hideHandle, // custom: let a drawer suppress the built-in grab pill and host its own inside a blurred header
  ...props
}: React.ComponentProps<typeof DrawerPrimitive.Popup> & { hideHandle?: boolean }) {
  return (
