...
function SidebarProvider({
  ...
  // oxlint-disable-next-line react/hook-use-state -- scaffolded shadcn pattern: internal state with external override
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // eslint-disable-next-line react-compiler/react-compiler -- custom: scaffolded shadcn code writes cookie as side effect
  ...
  ); // custom: rename params to avoid shadowing 'open'
  ...
  React.useEffect(() => {
    ...
    globalThis.addEventListener("keydown", handleKeyDown); // custom: globalThis per lint
    return () => globalThis.removeEventListener("keydown", handleKeyDown); // custom: globalThis per lint
  }, [toggleSidebar]);
...
function SidebarMenuButton({
  ...
  const comp = useRender({
    ...
    render: tooltip ? <TooltipTrigger render={render} /> : render, // custom: avoid negated condition per lint
    state: {
...
function SidebarMenuSkeleton({
  ...
  // oxlint-disable-next-line react/hook-use-state -- scaffolded shadcn pattern: stable random value, setter intentionally unused
