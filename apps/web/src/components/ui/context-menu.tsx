...
function ContextMenuSubTrigger({
  ...
  return (
    <ContextMenuPrimitive.SubmenuTrigger
      ...
      className={cn(
        // custom: bg-muted highlight — --accent resolves to --primary, so the scaffold's accent wash paints the brand color at full strength
        "focus:bg-muted focus:text-foreground data-open:bg-muted data-open:text-foreground flex cursor-default items-center gap-1.5 rounded-md px-1.5 py-1 text-sm outline-hidden select-none data-inset:pl-7 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    >
