...
function ContextMenuItem({
  ...
  return (
    <ContextMenuPrimitive.Item
      ...
      className={cn(
        // custom: recolor all descendants on highlight (not-data-[variant=destructive]:focus:**:), matching SelectItem, so muted text inside items (printing codes, split hints) stays readable on the accent fill
