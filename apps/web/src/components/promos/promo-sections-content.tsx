...
import { useCardBrowserLayoutOffsets } from "@/components/card-browser-layout";
import { CompactSection } from "@/components/promos/promo-compact-section";
import { FlatSection } from "@/components/promos/promo-flat-section";
import { LeafSection } from "@/components/promos/promo-leaf-section";
import { buildGridProps } from "@/components/promos/promo-section-grid";
import { Button } from "@/components/ui/button";
import { useActiveSection } from "@/hooks/use-active-section";
import type { CardThumbnailDisplay } from "@/hooks/use-card-thumbnail-display";
import { useResponsiveColumns } from "@/hooks/use-responsive-columns";
import type { PromoGrouping } from "@/lib/promo-groupings";
import type { ChannelRenderItem, FlatRenderItem } from "@/lib/promo-sections";
