...
import type * as runJob from "../../system/services/run-job.js";
...
import { adminMetaCatalogRouter } from "./admin-meta-catalog";
...
vi.mock("../../system/services/run-job.js", async (importOriginal) => ({
