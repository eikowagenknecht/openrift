...
const SET_SLUG = "OGS"; // Proving Grounds, the smallest set (24 cards)
...
/** Underscore separators keep generated numeric literals oxlint-compliant. */
...
// card_errata and card_bans are synthetic: OGS has none in the dev DB.
