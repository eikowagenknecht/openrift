...
const handler = new OpenAPIHandler(adminPrintingEventsRouter, {
...
for (const path of [
  "/api/admin/v1/printing-events",
  "/api/admin/v1/printing-events/flush",
  "/api/admin/v1/printing-events/retry",
]) {
  app.all(path, handle);
}
