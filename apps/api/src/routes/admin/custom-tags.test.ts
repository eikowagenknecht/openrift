...
const handler = new OpenAPIHandler(adminCustomTagsRouter, { interceptors: [appErrorInterceptor] });
...
for (const path of [
  ...
  "/api/admin/v1/custom-tag-categories/:id",
  "/api/admin/v1/custom-tags",
  "/api/admin/v1/custom-tags/assignments",
  "/api/admin/v1/custom-tags/:id",
  "/api/admin/v1/custom-tags/:id/cards",
  "/api/admin/v1/cards/:id/custom-tags",
]) {
  app.all(path, handle);
}
